...
namespace MES.DAL
{
    public class DBTool
    {
        ...
        /// <summary>
        /// 使用Batch快速插入大量数据（100W/8s）,传入的Table结构需要与数据库中相同
        /// </summary>
        /// <param name="dt"></param>
        ...
        public int TransactionTable(string sql)
        {
            ...
            finally
            {
                ...
                Debug.WriteLine("m_sqlCon---------------->入库耗时：" + use.TotalMilliseconds + "ms");
            }
        }
        ...
        public int ModifyTable(string sql, params SqlParameter[] ps)
        {
            ...
            finally
            {
                ...
                Debug.WriteLine("m_sqlConparams---------------->更新耗时：" + use.TotalMilliseconds + "ms");
            }
        }
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    product = new Product
                    {
                        ...
                        WeldPower = Convert.ToInt32(reader["WeldPower"]),
