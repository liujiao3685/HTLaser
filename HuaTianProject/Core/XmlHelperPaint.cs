...
namespace HuaTianProject.Core
{
    public class XmlHelperPaint
    {
        ...
        /// 配置文件保存路径
        /// </summary>
        public static string XmlSavePath = Application.StartupPath + @"\" + ShapeType + ".xml";

        /// <summary>
        /// 若文件不存在则重新创建
        /// </summary>
        /// <returns></returns>
        public static bool CreatePaintXmlFile()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static Dictionary<string, string> LoadPaintSetting()
        {
        ...
        /// <returns></returns>
        public static bool SavePaintSetting(Dictionary<string, string> dicPoints)
        {
            if (!File.Exists(XmlSavePath))
            {
                CreatePaintXmlFile();
